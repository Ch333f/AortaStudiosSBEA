...
* * *
## 📋 Overview
**Deliverable:** Functional Prototype via GitHub
**Expected Time:** 4-6 hours (Scenario 1) + 2-4 hours (Scenario 2 - Bonus)
...
*   Tests (unit, integration, or load tests as you see fit)
**2\.** [**README.md**](http://README.md)
*   Instructions to run your solution locally
*   Setup requirements and dependencies
*   Any assumptions you made
*   (Optional) Documentation of load testing results or performance benchmarks
**3\. Architecture Documentation:** [**`architecture.md`**](http://architecture.md)
...
**Focus:** ACID Compliance, Concurrency, Race Conditions
### The Problem
...
*   Prevention of race conditions and overselling
**Edge Cases:**
...
*   Comment history retrieval for new viewers or those seeking through video
**Edge Cases:**
...
*   Any other operations necessary
...
If you complete both scenarios and want to showcase additional skills, consider:
...
**The Task**:
Build the WebSocket Server that orchestrates playback and comment syncing.
**Technical Requirements:**
...
2\. The Documentation ([README.md](http://README.md))
